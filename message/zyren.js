...
//=================================================//
const tzy = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "14169948404-1305080833@g.us" } : {}) },"message": {"extendedTextMessage": {"text": "STN 666","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "6281226416919@s.whatsapp.net" }}}}
const pak = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"extendedTextMessage": {"text": "STN 666","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "@s.whatsapp.net"}}}}
...
const doc = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"documentMessage": {"url": "https://mmg.whatsapp.net/d/f/Aj85sbZCtNtq1cJ6JupaBUTKfgrl2zXRXGvVNWAbFnsp.enc","mimetype": "application/octet-stream","fileSha256": "TSSZu8gDEAPhp8vjdtJS/DXIECzjrSh3rmcoHN76M9k=","fileLength": "64455","pageCount": 1,"mediaKey": "P32GszzU5piUZ5HKluLD5h/TZzubVJ7lCAd1PIz3Qb0=","fileName": `STN 666${ngazap(prefix)}`,"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="}}}
const trol = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"orderMessage": {"orderId": "594071395007984","thumbnail": fs.readFileSync("./media/gambarnye/thezyren.jpg"),"itemCount": 100000000000,"status": "INQUIRY","surface": "CATALOG","message": "STN 666","orderTitle": "STN 666  ","sellerJid": "6281226416919@s.whatsapp.net","token": "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==","totalAmount1000": "500000000000000","totalCurrencyCode": "IDR"}}}
const ngetrol = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"orderMessage": {"orderId": "594071395007984","thumbnail": fs.readFileSync("./media/gambarnye/thezyren.jpg"),"itemCount": 100000000000,"status": "INQUIRY","surface": "CATALOG","message": "STN 666","orderTitle": "STN 666  ${ngazap(prefix)}","sellerJid": "6281226416919@s.whatsapp.net","token": "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==","totalAmount1000": "500000000000000","totalCurrencyCode": "IDR" }}}
const ftrolii ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "@g.us"},"message": {orderMessage: {itemCount: 100000000000,status: 200, thumbnail: logonya, surface: 200, message: `${ownerName}`,token: "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==",totalAmount1000: "500000000000000",totalCurrencyCode: "IDR",orderTitle: `STN 666 ${ngazap(prefix)}`,sellerJid: "0@s.whatsapp.net"}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], externalAdReply: { showAdAttribution: true, title: "STN 666", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@STN 666556" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web2") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 9999, isForwarded: true, showAdAttribution: true, externalAdReply: { title: "STN 666", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@STN 666556" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web3") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 10, isForwarded: true, externalAdReply: { showAdAttribution: true, title: "STN 666", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/@STN 666556" }}, text: teks }, { quoted: tzy })
...
image: thumb,
mimeType: "image/jpg",
caption: `YouTube: http://youtube.com/@satan666`,
footer: copyright,
buttons: buttons,
headerType: 4
}
...
sourceUrl: `http://youtube.com/@satan666`,
...
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": "http://youtube.com/@satan666",
"sourceUrl": "http://youtube.com/@satan666"
}}
}
...
case "yt": {
if (isBan) return //sticBanLu(from)
setReply("My Chenell : https://youtube.com/@satann666")
}
break
//=================================================//
case "family100": {
...
//=================================================//
case "menu":{
a = await zyren.sendMessage(m.chat, {react: { text: "SABAR YA", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
...
{ urlButton: { displayText: `Youtube`, url: `http://youtube.com/@satan666` } },
